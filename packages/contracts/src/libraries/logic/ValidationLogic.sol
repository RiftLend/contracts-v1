...
library ValidationLogic {
        ...
        if (currentRateMode == DataTypes.InterestRateMode.VARIABLE) {
            ...
            require(
                !userConfig.isUsingAsCollateral(reserve.id) || reserve.configuration.getLtv() == 0
                    || stableDebt + variableDebt > IERC20(reserve.rTokenAddress).balanceOf(msg.sender),
     ...
     * @param rTokenAddress The address of the aToken contract
     */
    function validateRebalanceStableBorrowRate(
        ...
        uint256 availableLiquidity = IERC20(reserveAddress).balanceOf(rTokenAddress).wadToRay();
