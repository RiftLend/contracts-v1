...
contract LendingPool is Initializable, LendingPoolStorage, SuperPausable {
    ...
    */
        ...
        onlyRouter
    {
        ...
        _updateStates(reserve, asset, 0, amountToWithdraw, DEPOSIT_WITHDRAW_UPDATE_STATE_MASK);
    ...
    function _executeBorrow(ExecuteBorrowParams memory vars) internal {
        ...
        _updateStates(reserve, vars.rTokenAddress, 0, vars.releaseUnderlying ? vars.amount : 0, bytes2(uint16(2)));
