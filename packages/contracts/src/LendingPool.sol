...
contract LendingPool is Initializable, LendingPoolStorage, SuperPausable {
    ...
    */
        ...
        onlyRouter
    {
        ...
        require(
            block.timestamp >= _lastWithdrawalTime[sender] + WITHDRAW_COOL_PERIOD, "Withdrawal cooldown period not met"
        );
    ...
    function flashLoan(
        ...
        for (vars.i = 0; vars.i < assets.length; vars.i++) {
            ...
            if (DataTypes.InterestRateMode(modes[vars.i]) == DataTypes.InterestRateMode.NONE) {
                ...
                ISuperAsset(vars.currentAsset).mint(vars.currentATokenAddress, vars.currentAmountPlusPremium);
            } else {
